...
const Client = () => {
    return (
        ...
        <h2 className=' font-bold text-teal-800 text-5xl  mb-5 p-10 space-y-3'>Meet Our Top<br/> Clients and Partners</h2>
            ...
            <div className='mt-28'>
                <h2>We Appriciate your trust.meet our client who choose use as their kids toys supplier and whom we are happy to work with them</h2>
                <h2 className='mt-5'>We only turn on the mix of disciplines that will actually deliver success -- earned media, influencers, social media, direct marketing, partnerships, programming, event execution and more.</h2>
